        ...
        <StyledWrapper>
            <label className="container">
                ...
                <div className="checkmark">
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon No" viewBox="0 0 16 16">
                    ...
                    <p className="No name">PathFinder</p>
                    <svg viewBox="0 0 16 16" className="icon Yes" xmlns="http://www.w3.org/2000/svg">
